...
- The Overview daily card presents price movement as four short indicators and separates market context from a six-region Open-Meteo weather block. Weather selection is strictly as-of the start of the delivery day, so a later forecast revision cannot appear in a historical card. It is unweighted and descriptive until demand and generation coverage can support a calibrated market signal.
